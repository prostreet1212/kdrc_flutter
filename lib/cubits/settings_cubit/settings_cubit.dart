...
class SettingsCubit extends Cubit<SettingsState>{
  ...
  SettingsCubit( ) : super(SettingsState(isCalling: sl<SharedPreferences>().getBool(_isCallingKey)??true, isPush: sl<SharedPreferences>().getBool(_isPushKey)??false,isFirstPushRequest: sl<SharedPreferences>().getBool(_isFirstPushRequestKey)??true));
